...
const fieldGroups: FieldGroup[] = [
  {
    title: 'Bed Details',
    fields: [
      { name: 'wardId', label: 'Ward', type: 'async-select', searchParam: { endpoint: '/wards', valueKey: 'id', labelKey: 'name', minChars: 1 }, required: true, col: 6 },
      { name: 'code', label: 'Bed code', type: 'text', required: true, col: 6 },
      { name: 'bedType', label: 'Bed type', type: 'select', options: toSelectData(BED_TYPES), col: 6 },
      { name: 'status', label: 'Status', type: 'select', options: toSelectData(BED_STATUSES), col: 6 },
