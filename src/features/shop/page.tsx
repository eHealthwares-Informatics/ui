                  ...
                  <Group gap={8}>
                    {quickSearches.map((tag) => (
                      <Button
                        ...
                        styles={buttonStyles}
                        onClick={() =>
                          navigate({ to: `/shop/search?q=${encodeURIComponent(tag)}` })
                        }
                      >
                        {tag}
                      </Button>
          ...
          <SimpleGrid cols={{ base: 2, sm: 3, lg: 4 }} spacing="md">
            {healthConcerns.map((item) => (
              <Card
                ...
                onClick={() => navigate({ to: `/shop/health-concerns/${item.slug}` })}
              >
                <Stack gap="sm">
                  ...
                  <Anchor
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate({ to: `/shop/health-concerns/${item.slug}` });
                    }}
                  >
            ...
            {products.map((item) => (
              ...
              >
                <Card.Section
                  ...
                  onClick={() => navigate({ to: '/shop/shop/$slug', params: { slug: item.id } })}
                >
                  <Badge
                    radius="xl"
                    color="green"
                  ...
                  >
                    <Stack h="100%" justify="space-between">
                      ...
                      <Anchor
                        ...
                        underline="never"
                        className="damorex-link"
                        onClick={() => navigate({ to: `/shop/blog/${article.slug}` })}
                      >
                        Read article
                      </Anchor>
                    </Stack>
